...
var replaceTopicReferenceWithValue = function (model, topicReference, value) {
...
var getTopicReferences = function (model) {
  var topics = [];
...
var getNextTopicReference = function (model) {
  return getTopicReferences(model)[0];
};
...
var bindModel = function (results, model, topics) {
  var num;
  var formattedNumber;
  var count;
  var item;
...
var compile = function (models, topics) {
  ...
  return bindModels(expandedModels, topics);
};
